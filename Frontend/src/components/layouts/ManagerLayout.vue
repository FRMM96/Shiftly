...
const currentUser = computed(() => ({
  name: userStore.user?.username || 'Alex Thompson',
  role: userStore.user?.role || 'REGIONAL ADMIN',
...
:root {
  ...
  --red-bg: #FEF2F2; --red-border: #EF4444; --red-text: #991B1B;
  --orange-bg: #FFF7ED; --orange-border: #F59E0B; --orange-text: #9A3412;
  --blue-bg: #EFF6FF; --blue-border: #3B82F6; --blue-text: #1E40AF;
  --green-bg: #DCFCE3; --green-border: #10B981; --green-text: #166534;
}
