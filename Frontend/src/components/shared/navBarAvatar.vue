<template>
    <BDropdown no-caret toggle-class="p-0 border-0 bg-transparent d-flex align-items-center" class="d-inline-block">
        ...
        <BDropdownItemButton class="text-danger" @click="logout"
